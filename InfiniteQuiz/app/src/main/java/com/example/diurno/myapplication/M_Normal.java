...
public class M_Normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_normal);
        ...
        dificultad = intent.getStringExtra(Inicio.DIFICULTAD_EXTRA);
            ...
            public void onClick(View v) {
                ...
                if (!contestada) {
                    ...
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(M_Normal.this, "Porfavor, seleccione una respuesta", Toast.LENGTH_SHORT).show();
                    }
                } else {
